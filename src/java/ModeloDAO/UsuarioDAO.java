...
public class UsuarioDAO {
    ...
    public boolean registrarUsuario(Usuario u) {
        ...
        try {
            ...
            String sql = "INSERT INTO usuarios (dpi, nombre, usuario, area, area_id, puesto, turno_actual_id, correo, password, estado, motivo_inactivo_id, rol_id, admin_responsable_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Usuario> listarUsuarios(String buscar) {
        ...
        try {
            ...
            String sql = "SELECT u.*, r.nombre AS rol_nombre, t.nombre AS turno_nombre, a.nombre AS area_nombre, adm.nombre AS admin_nombre FROM usuarios u LEFT JOIN roles r ON u.rol_id = r.id LEFT JOIN turnos_catalogo t ON u.turno_actual_id = t.id LEFT JOIN areas a ON u.area_id = a.id LEFT JOIN usuarios adm ON u.admin_responsable_id = adm.id WHERE u.nombre LIKE ? OR u.usuario LIKE ? OR u.dpi LIKE ? ORDER BY u.nombre";
